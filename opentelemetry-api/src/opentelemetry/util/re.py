...
_KEY_VALUE_FORMAT = r"{}{}{}={}{}{}".format(_OWS, _KEY_FORMAT, _OWS, _OWS, _VALUE_FORMAT, _OWS)

_HEADER_PATTERN = compile(_KEY_VALUE_FORMAT)
_LIBERAL_HEADER_PATTERN = compile(
    r"{}{}{}={}{}{}".format(_OWS, _KEY_FORMAT, _OWS, _OWS, _LIBERAL_VALUE_FORMAT, _OWS)
)
_DELIMITER_PATTERN = compile(r"[ \t]*,[ \t]*")

_BAGGAGE_PROPERTY_FORMAT = r"{}|{}{}{}".format(_KEY_VALUE_FORMAT, _OWS, _KEY_FORMAT, _OWS)
...
def parse_env_headers(s, liberal = False):
    ...
    """
    headers = {}
    headers_list = split(_DELIMITER_PATTERN, s)
    for header in headers_list:
        ...
        if header_match:
            match_string = header_match.string
            ...
            liberal_match_string = liberal_header_match.string
            # value may contain any number of `=`
