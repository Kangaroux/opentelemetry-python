...
class SpanAttributes(object):
    ...
    Note: For network calls, URL usually has `scheme://host` format, where the fragment is not transmitted over HTTP, but if it is known, it should be included nevertheless.
